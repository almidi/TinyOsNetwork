...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f2751fd5cf8, const void *arg_0x7f2751fd4020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f2751f54618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f2751d0b020), 
int (*key_eq_fn)(void *arg_0x7f2751d0b798, void *arg_0x7f2751d0ba38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f2751b07610, int arg_0x7f2751b07878);
static double RandomUniform(void );
...
static void SRTreeC__calculateSubQ__runTask(void );
#line 75
...
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
static error_t SRTreeC__calculateSubQ__postTask(void );
#line 67
...
#line 127
  SRTreeC__calculateSubQ = 8U
};
#line 127
typedef int SRTreeC____nesc_sillytask_calculateSubQ[SRTreeC__calculateSubQ];
#line 62
...
uint32_t SRTreeC__SUM[1000];
uint32_t SRTreeC__COUNT[1000];
uint32_t SRTreeC__MAX[1000];




uint8_t SRTreeC__qem[1000][6];
...
#line 235
static inline __nesc_nxbase_nx_uint16_t SRTreeC__getSenderID(void *m);
#line 274
static inline nx_uint32_t *SRTreeC__getNumPtr(void *m);
#line 288
static inline void SRTreeC__initCdm(void );
#line 327
static inline void SRTreeC__pack(nx_uint32_t *m_array, uint32_t *d_array);
#line 342
...
static inline void SRTreeC__calculateSubQ__runTask(void );
...
#line 599
{
  ...
  sim_log_debug(74U, "Routing", "RoutingReceive.receive(): Something received!!!  from %u - Original source %u \n", __nesc_ntoh_uint8(((RoutingMsg *)payload)->senderID.nxdata), msource);

  if (len != sizeof(RoutingMsg )) 
    {
      sim_log_debug(75U, "SRTreeC", "RoutingReceive.receive() %sUnknown message received!!!%s\n", "\x1B[31m", "\x1B[0m");
      return msg;
    }
...
#line 616
  ...
  sim_log_debug(76U, "Routing", "RoutingReceive.receive(): RoutingMsg enqueue %s %s\n", enqueueDone == SUCCESS ? "\x1B[32mSuccessful" : "\x1B[31mFailed", "\x1B[0m");
...
#line 568
{
  ...
  sim_log_debug(72U, "NotifyParentMsg", "NotifyReceive.receive(): Something received!!!  from %u - Original source %u \n", __nesc_ntoh_uint16(((NotifyParentMsg *)payload)->senderID.nxdata), msource);
...
#line 585
  ...
  sim_log_debug(73U, "NotifyParentMsg", "NotifyReceive.receive(): NotifyMsg enqueue %s!!! %s\n", enqueueDone == SUCCESS ? "\x1B[32mSuccessful" : "\x1B[31mFailed", "\x1B[0m");
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f2751699a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f2751699a90) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f2751699a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f2751698670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f2751698670, msg, payload, len);
#line 78
...
#line 634
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) {
      sim_log_debug(77U, "Routing", "sendRoutingTask(): %sQ is empty%s\n", "\x1B[31m", "\x1B[0m");
      return;
    }


  if (SRTreeC__RoutingSendBusy[sim_node()]) {
      sim_log_debug(78U, "Routing", "sendRoutingTask(): %sRoutingSendBusy= TRUE%s\n", "\x1B[31m", "\x1B[0m");
  ...
  if (mlen != sizeof(RoutingMsg )) {
      sim_log_debug(79U, "Routing", "sendRoutingTask(): %sUnknown message%s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
...
#line 674
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) {
      sim_log_debug(81U, "SRTreeC", "sendNotifyTask(): Q is empty!\n");
      return;
    }

  if (SRTreeC__NotifySendBusy[sim_node()] == TRUE) {
      sim_log_debug(82U, "SRTreeC", "sendNotifyTask(): NotifySendBusy= TRUE!!!\n");
  ...
  if (mlen != SRTreeC__ms[sim_node()][SRTreeC__numOfSubQ[sim_node()] - 1]) {
      sim_log_debug(83U, "SRTreeC", "\t\t sendNotifyTask(): Unknown message!!\n");
      return;
    }

  sim_log_debug(84U, "SRTreeC", "sendNotifyTask(): mlen = %u  senderID= %u \n", mlen, SRTreeC__getSenderID(mpayload));
  ...
  if (sendDone == SUCCESS) {
      sim_log_debug(85U, "SRTreeC", "sendNotifyTask(): %sSend Success!!!%s\n", "\x1B[32m", "\x1B[0m");
    }
  else 
#line 714
    {
      sim_log_debug(86U, "SRTreeC", "sendNotifyTask(): %sSend Failed!!!%s\n", "\x1B[31m", "\x1B[0m");
...
#line 73
# 67 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static error_t SRTreeC__calculateSubQ__postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP__TaskBasic__postTask(SRTreeC__calculateSubQ);
#line 67
...
#line 722
{
  ...
  sim_log_debug(87U, "Routing", "ReceiveRoutingTask(): Function called with packet length =%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) {
      ...
      sim_log_debug(88U, "Routing", "receiveRoutingTask(): Routing Message Packet -> senderID= %d , senderDepth= %d , size= %d \n", __nesc_ntoh_uint8(mpkt->senderID.nxdata), __nesc_ntoh_uint8(mpkt->depth.nxdata), sizeof mpkt);
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) {
          ...
          SRTreeC__query1[sim_node()] = __nesc_ntoh_uint8(mpkt->query.nxdata) & 15;
          SRTreeC__query2[sim_node()] = __nesc_ntoh_uint8(mpkt->query.nxdata) >> 4;

          SRTreeC__calculateSubQ__postTask();
          sim_log_debug(89U, "Routing", "receiveRoutingTask(): %sNode routed -> Parent = %d, Depth = %d, Query1 = %d, Query2 = %d%s\n", "\x1B[34m", SRTreeC__parentID[sim_node()], SRTreeC__curdepth[sim_node()], SRTreeC__query1[sim_node()], SRTreeC__query2[sim_node()], "\x1B[0m");
          sim_log_debug(90U, "Query", "receiveRoutingTask(): %sQuery Requests Received: Query1 = %d, Query2 = %d%s\n", "\x1B[34m", SRTreeC__query1[sim_node()], SRTreeC__query2[sim_node()], "\x1B[0m");

          sim_log_debug(91U, "Routing", "receiveRoutingTask(): Call RoutingMsgTimer to route children%s\n", "\x1B[0m");
          if (TOS_NODE_ID != 0) {
      ...
      sim_log_debug(92U, "Routing", "receiveRoutingTask(): %sEmpty message%s\n", "\x1B[31m", "\x1B[0m");
...
#line 770
{
  ...
  sim_log_debug(93U, "NotifyParentMsg", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == SRTreeC__ms[sim_node()][SRTreeC__numOfSubQ[sim_node()] - 1]) {
      ...
      sim_log_debug(94U, "NotifyParentMsg", "NotifyParentMsg received from %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));

      if (__nesc_ntoh_uint16(mr->parentID.nxdata) == TOS_NODE_ID) {



          __nesc_hton_uint16(SID.nxdata, __nesc_ntoh_uint16(mr->senderID.nxdata));
          ...
          for (i = 0; i < SRTreeC__DataQueue__size(); i++) {
              ...
              mr = (NotifyParentMsg *)SRTreeC__NotifyPacket__getPayload(&tmp, len);


              if (__nesc_ntoh_uint16(mr->senderID.nxdata) != __nesc_ntoh_uint16(SID.nxdata)) {

                  SRTreeC__DataQueue__enqueue(tmp);
                }
              else {

                  sim_log_debug(95U, "NotifyParentMsg", "receiveNotifyTask():Enqueued updated message in DataQueue \n");
          ...
          if (!found) {
              SRTreeC__DataQueue__enqueue(radioNotifyRecPkt);
              sim_log_debug(96U, "NotifyParentMsg", "receiveNotifyTask():Enqueued new message in DataQueue \n");
            }
        }
    }
  else 
    ...
    {
      sim_log_debug(97U, "NotifyParentMsg", "receiveNotifyTask():%sEmpty message!!!%s \n", "\x1B[31m", "\x1B[0m");
...
#line 836
{
  ...
  sim_log_debug(98U, "Timing", "startEpoch(): %sStarted Epoch Timer. Offset Milli = %d%s\n", "\x1B[36m", SRTreeC__offset_milli[sim_node()], "\x1B[0m");
}
...
#line 327
{
  uint8_t i;
  uint8_t index = 0;
  uint8_t TempNumOfSubQ = SRTreeC__numOfSubQ[sim_node()];

  __nesc_hton_uint32(m_array[0].nxdata, 1);
}
...
#line 879
{
  ...
  SRTreeC__pack(SRTreeC__getNumPtr(m), SRTreeC__cdm[sim_node()]);
}
...
#line 910
{
  ...
  sim_log_debug(99U, "Root", "\n");
  sim_log_debug(100U, "Root", "rootResults(): %s################################################### ROOT RESULTS FOR EPOCH %d ###################################################s\n", "\x1B[34m", SRTreeC__epochCounter[sim_node()], "\x1B[0m");
}
...
#line 921
{
  ...
  if (SRTreeC__query1[sim_node()] > 6 || SRTreeC__query2[sim_node()] > 6) {
      sim_log_debug(101U, "Query", "calculateSubQ(): %sUnknown Query %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }

  SRTreeC__subquerys[sim_node()] = SRTreeC__subquerys[sim_node()] | SRTreeC__qem[sim_node()][SRTreeC__query1[sim_node()] - 1];
  SRTreeC__subquerys[sim_node()] = SRTreeC__subquerys[sim_node()] | SRTreeC__qem[sim_node()][SRTreeC__query2[sim_node()] - 1];
...
#line 935
  ...
  sim_log_debug(102U, "Query", "calculateSubQ(): Calculcated subquerys= %d, numOfSubQ=%d\n", SRTreeC__subquerys[sim_node()], SRTreeC__numOfSubQ[sim_node()]);
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(49U, "Radio", "RadioControl.StartDone():%s Radio initialized successfully!!!%s\n", "\x1B[33m", "\x1B[0m");
...
#line 400
    {
      sim_log_debug(50U, "Radio", "RadioControl.StartDone():%s Radio initialization failed! Retrying...%s\n", "\x1B[31m", "\x1B[0m");
...
#line 407
{
  sim_log_debug(51U, "Radio", "RadioControl.stopDone():%s Radio stopped!%s\n", "\x1B[33m", "\x1B[0m");
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f27516a1970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f27516a1970, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f2751139990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f2751139990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f2751139990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f27519e1108){
#line 75
  switch (arg_0x7f27519e1108) {
#line 75
...
#line 75
      break;
#line 75
    case SRTreeC__calculateSubQ:
#line 75
      SRTreeC__calculateSubQ__runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f27519e1108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f2751138c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f2751138c70, addr, msg, len);
#line 80
...
#line 442
  sim_log_debug(52U, "Routing", "RoutingMsgTimer fired! -----------------------------------------------------------------\n");
  sim_log_debug(53U, "Routing", "RoutingMsgTimer.fired(): radioBusy = %s %s\n", SRTreeC__RoutingSendBusy[sim_node()] ? "\x1B[31mTrue" : "\x1B[32mFalse", "\x1B[0m");

  if (TOS_NODE_ID == 0) {


      sim_log_debug(54U, "SRTreeC", "%s\n", "\x1B[36m");
      sim_log_debug(55U, "SRTreeC", "######################################################################################## \n");
      sim_log_debug(56U, "SRTreeC", "################################   Initialize Routing   ################################ \n");
      sim_log_debug(57U, "SRTreeC", "########################################################################################%s\n", "\x1B[0m");
      sim_log_debug(58U, "SRTreeC", "\n");
    }


  if (SRTreeC__RoutingSendQueue__full()) {
      sim_log_debug(59U, "Routing", "RoutingMsgTimer.fired(): %sRouting Send Q Full... %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
  ...
  if (mrpkt == (void *)0) {
      sim_log_debug(60U, "Routing", "RoutingMsgTimer.fired(): %sNo valid payload... %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }


  query = SRTreeC__query2[sim_node()] << 4;
  query = query | SRTreeC__query1[sim_node()];
  sim_log_debug(61U, "Routing", "RoutingMsgTimer.fired(): Calculated Query = %d\n", query);
...
#line 478
  ...
  sim_log_debug(62U, "Routing", "RoutingMsgTimer.fired(): Sending RoutingMsg... \n");
  ...
  if (enqueueDone == SUCCESS) {
      sim_log_debug(63U, "Routing", "RoutingMsgTimer.fired(): %sRoutingMsg enqueued successfully in SendingQueue!!!%s\n", "\x1B[32m", "\x1B[0m");
      if (SRTreeC__RoutingSendQueue__size() == 1) {
          sim_log_debug(64U, "Routing", "RoutingMsgTimer.fired(): %sSendTask() posted!!%s\n", "\x1B[32m", "\x1B[0m");
          SRTreeC__sendRoutingTask__postTask();
        }
      else 
        {
          sim_log_debug(65U, "Routing", "RoutingMsgTimer.fired(): %sRouting Queue != 1 %s\n", "\x1B[31m", "\x1B[0m");
        }
    }
  else 
#line 500
    {
      sim_log_debug(66U, "Routing", "RoutingMsgTimer.fired(): %sRoutingMsg failed to be enqueued in SendingQueue!!!%s\n", "\x1B[31m", "\x1B[0m");
    }
...
#line 512
{
  ...
  sim_log_debug(67U, "Timing", "EpochTimer.fired(): %s######################################################## EPOCH %d %s\n", "\x1B[36m", SRTreeC__epochCounter[sim_node()], "\x1B[0m");
  ...
  sim_log_debug(68U, "Measure", "EpochTimer.fired(): %sMeasured %d %s\n", "\x1B[35m", measurement, "\x1B[0m");
...
#line 541
{
  sim_log_debug(69U, "Timing", "SlotTimer.fired(): %sTime to Send Data %s\n", "\x1B[33m", "\x1B[0m");
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f27511e12f8){
#line 83
  switch (arg_0x7f27511e12f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f27511e12f8);
#line 83
      break;
#line 83
    }
...
#line 342
{
  ...
  SRTreeC__COUNT[sim_node()] = 1;
  SRTreeC__MAX[sim_node()] = 0;


  SRTreeC__cdm[sim_node()][0] = 0;
  SRTreeC__cdm[sim_node()][1] = 0;
  SRTreeC__cdm[sim_node()][2] = 0;
  SRTreeC__cdm[sim_node()][3] = 0;
  SRTreeC__cdm[sim_node()][4] = 0;
  ...
  if (TOS_NODE_ID == 0) {
      ...
      SRTreeC__query1[sim_node()] = SRTreeC__RandomGenerator__rand16() % 5 + 1;
      SRTreeC__query2[sim_node()] = SRTreeC__RandomGenerator__rand16() % 5 + 1;

      if (SRTreeC__RandomGenerator__rand16() % 1 || SRTreeC__query1[sim_node()] == SRTreeC__query2[sim_node()]) {
#line 374
          SRTreeC__query2[sim_node()] = 0;
        }
#line 375
      sim_log_debug(47U, "Boot", "%sROOT Node Booted:%s curdepth = %03d  ,  parentID= %d, Query1 = %d, Query2 = %d\n", "\x1B[33m", "\x1B[0m", SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()], SRTreeC__query1[sim_node()], SRTreeC__query2[sim_node()]);
    }
  else {
...
#line 558
{
  sim_log_debug(71U, "SRTreeC", "NotifyAMSend.sendDone(): A Notify package sent... %s %s\n", err == SUCCESS ? "\x1B[32mTrue" : "\x1B[31mFalse", "\x1B[0m");
  SRTreeC__setNotifySendBusy(FALSE);
...
#line 548
{
  sim_log_debug(70U, "Routing", "RoutingAMSend.sendDone(): A Routing package sent... %s %s\n", err == SUCCESS ? "\x1B[32mTrue" : "\x1B[31mFalse", "\x1B[0m");
  SRTreeC__setRoutingSendBusy(FALSE);
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SRTreeC__qem"))
  {
    *addr = (uintptr_t)&SRTreeC__qem[__nesc_mote];
    *size = sizeof(SRTreeC__qem[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memcpy((void *)&SRTreeC__qem[__nesc_mote], (void *)&(unsigned char [6]){ 0b00001, 0b00100, 0b01000, 0b10000, 0b00101, 0b00110 }, sizeof SRTreeC__qem[__nesc_mote]);
