...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7fab5dca4cf8, const void *arg_0x7fab5dca3020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7fab5dc23618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fab5d9da020), 
int (*key_eq_fn)(void *arg_0x7fab5d9da798, void *arg_0x7fab5d9daa38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fab5d7d6610, int arg_0x7fab5d7d6878);
static double RandomUniform(void );
...
#line 377
{
  ...
  sim_log_debug(72U, "Routing", "RoutingReceive.receive(): Something received!!!  from %u - Original source %u \n", __nesc_ntoh_uint16(((RoutingMsg *)payload)->senderID.nxdata), msource);
...
#line 394
  ...
  sim_log_debug(73U, "Routing", "RoutingReceive.receive(): RoutingMsg enqueue %s %s\n", enqueueDone == SUCCESS ? "\x1B[32mSuccessful" : "\x1B[31mFailed", "\x1B[0m");
...
#line 346
{
  ...
  sim_log_debug(70U, "NotifyParentMsg", "NotifyReceive.receive(): Something received!!!  from %u - Original source %u \n", __nesc_ntoh_uint16(((NotifyParentMsg *)payload)->senderID.nxdata), msource);
...
#line 363
  ...
  sim_log_debug(71U, "NotifyParentMsg", "NotifyReceive.receive(): NotifyMsg enqueue %s!!! %s\n", enqueueDone == SUCCESS ? "\x1B[32mSuccessful" : "\x1B[31mFailed", "\x1B[0m");
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fab5d3aaa90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fab5d3aaa90) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fab5d3aaa90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fab5d3a9670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fab5d3a9670, msg, payload, len);
#line 78
...
#line 411
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) {
      sim_log_debug(74U, "Routing", "sendRoutingTask(): %sQ is empty%s\n", "\x1B[31m", "\x1B[0m");
      return;
    }


  if (SRTreeC__RoutingSendBusy[sim_node()]) {
      sim_log_debug(75U, "Routing", "sendRoutingTask(): %sRoutingSendBusy= TRUE%s\n", "\x1B[31m", "\x1B[0m");
  ...
  if (mlen != sizeof(RoutingMsg )) {
      sim_log_debug(76U, "Routing", "sendRoutingTask(): %sUnknown message%s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
...
#line 451
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) {
      sim_log_debug(78U, "SRTreeC", "sendNotifyTask(): Q is empty!\n");
      return;
    }

  if (SRTreeC__NotifySendBusy[sim_node()] == TRUE) {
      sim_log_debug(79U, "SRTreeC", "sendNotifyTask(): NotifySendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(NotifyParentMsg )) {
      sim_log_debug(80U, "SRTreeC", "\t\t sendNotifyTask(): Unknown message!!\n");
      return;
    }

  sim_log_debug(81U, "SRTreeC", "sendNotifyTask(): mlen = %u  senderID= %u \n", mlen, __nesc_ntoh_uint16(mpayload->senderID.nxdata));
  ...
  if (sendDone == SUCCESS) {
      sim_log_debug(82U, "SRTreeC", "sendNotifyTask(): %sSend Success!!!%s\n", "\x1B[32m", "\x1B[0m");
    }
  else 
#line 489
    {
      sim_log_debug(83U, "SRTreeC", "sendNotifyTask(): %sSend Failed!!!%s\n", "\x1B[31m", "\x1B[0m");
...
#line 497
{
  ...
  sim_log_debug(84U, "Routing", "ReceiveRoutingTask(): Function called with packet length =%u \n", len);
  ...
  if (len == sizeof(RoutingMsg )) {
      ...
      sim_log_debug(85U, "Routing", "receiveRoutingTask(): Routing Message Packet -> senderID= %d , senderDepth= %d \n", __nesc_ntoh_uint16(mpkt->senderID.nxdata), __nesc_ntoh_uint8(mpkt->depth.nxdata));
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) {
          ...
          sim_log_debug(86U, "Routing", "receiveRoutingTask(): %sNode routed -> Parent = %d, Depth = %d%s\n", "\x1B[34m", SRTreeC__parentID[sim_node()], SRTreeC__curdepth[sim_node()], "\x1B[0m");

          sim_log_debug(87U, "Routing", "receiveRoutingTask(): Call RoutingMsgTimer to route children%s\n", "\x1B[0m");
          if (TOS_NODE_ID != 0) {
      ...
      sim_log_debug(88U, "Routing", "receiveRoutingTask(): %sEmpty message%s\n", "\x1B[31m", "\x1B[0m");
...
#line 539
{
  ...
  if (len == sizeof(NotifyParentMsg )) {
      ...
      if (__nesc_ntoh_uint16(mr->parentID.nxdata) == TOS_NODE_ID) {
          ...
          for (i = 0; i < SRTreeC__DataQueue__size(); i++) {
              ...
              if (__nesc_ntoh_uint16(mr->senderID.nxdata) != __nesc_ntoh_uint16(SID.nxdata)) {
                  ...
                  sim_log_debug(91U, "NotifyParentMsg", "receiveNotifyTask():Enqueued updated message in DataQueue \n");
          ...
          if (!found) {
              SRTreeC__DataQueue__enqueue(radioNotifyRecPkt);
              sim_log_debug(92U, "NotifyParentMsg", "receiveNotifyTask():Enqueued new message in DataQueue \n");
            }
        }
    }
  else 
    ...
    {
      sim_log_debug(93U, "NotifyParentMsg", "receiveNotifyTask():Empty message!!! \n");
...
#line 607
{
  ...
  sim_log_debug(94U, "Timing", "startEpoch(): %sStarted Epoch Timer. Offset Milli = %d%s\n", "\x1B[36m", SRTreeC__offset_milli[sim_node()], "\x1B[0m");
}
...
#line 655
{
  ...
  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) {
      sim_log_debug(95U, "NotifyParentMsg", "enqueueData(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
...
#line 680
{
  ...
  sim_log_debug(96U, "Root", "\n");
  sim_log_debug(97U, "Root", "rootResults(): %s################################################### ROOT RESULTS FOR EPOCH %d ###################################################s\n", "\x1B[34m", SRTreeC__epochCounter[sim_node()], "\x1B[0m");
  sim_log_debug(98U, "Root", "rootResults(): %s############  SUM   : %s%d %s\n", "\x1B[34m", "\x1B[35m", SRTreeC__SUM[sim_node()], "\x1B[0m");
  sim_log_debug(99U, "Root", "rootResults(): %s############  COUNT : %s%d %s\n", "\x1B[34m", "\x1B[35m", SRTreeC__COUNT[sim_node()], "\x1B[0m");
  sim_log_debug(100U, "Root", "rootResults(): %s############  AVG   : %s%d %s\n", "\x1B[34m", "\x1B[35m", AVG, "\x1B[0m");
  sim_log_debug(101U, "Root", "rootResults(): %s############  MAX   : %s%d %s\n\n", "\x1B[34m", "\x1B[35m", SRTreeC__MAX[sim_node()], "\x1B[0m");
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(48U, "Radio", "RadioControl.StartDone():%s Radio initialized successfully!!!%s\n", "\x1B[33m", "\x1B[0m");
...
#line 181
    {
      sim_log_debug(49U, "Radio", "RadioControl.StartDone():%s Radio initialization failed! Retrying...%s\n", "\x1B[31m", "\x1B[0m");
...
#line 188
{
  sim_log_debug(50U, "Radio", "RadioControl.stopDone():%s Radio stopped!%s\n", "\x1B[33m", "\x1B[0m");
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fab5d3b2970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fab5d3b2970, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fab5ce4c990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fab5ce4c990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fab5ce4c990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fab5d6b0108){
#line 75
  switch (arg_0x7fab5d6b0108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fab5d6b0108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fab5ce4bc70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fab5ce4bc70, addr, msg, len);
#line 80
...
#line 222
  sim_log_debug(51U, "Routing", "RoutingMsgTimer fired! -----------------------------------------------------------------\n");
  sim_log_debug(52U, "Routing", "RoutingMsgTimer.fired(): radioBusy = %s %s\n", SRTreeC__RoutingSendBusy[sim_node()] ? "\x1B[31mTrue" : "\x1B[32mFalse", "\x1B[0m");

  if (TOS_NODE_ID == 0) {


      sim_log_debug(53U, "SRTreeC", "%s\n", "\x1B[36m");
      sim_log_debug(54U, "SRTreeC", "######################################################################################## \n");
      sim_log_debug(55U, "SRTreeC", "################################   Initialize Routing   ################################ \n");
      sim_log_debug(56U, "SRTreeC", "########################################################################################%s\n", "\x1B[0m");
      sim_log_debug(57U, "SRTreeC", "\n");
    }


  if (SRTreeC__RoutingSendQueue__full()) {
      sim_log_debug(58U, "Routing", "RoutingMsgTimer.fired(): %sRouting Send Q Full... %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
  ...
  if (mrpkt == (void *)0) {
      sim_log_debug(59U, "Routing", "RoutingMsgTimer.fired(): %sNo valid payload... %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
...
#line 252
  ...
  sim_log_debug(60U, "Routing", "RoutingMsgTimer.fired(): Sending RoutingMsg... \n");
  ...
  if (enqueueDone == SUCCESS) {
      sim_log_debug(61U, "Routing", "RoutingMsgTimer.fired(): %sRoutingMsg enqueued successfully in SendingQueue!!!%s\n", "\x1B[32m", "\x1B[0m");
      if (SRTreeC__RoutingSendQueue__size() == 1) {
          sim_log_debug(62U, "Routing", "RoutingMsgTimer.fired(): %sSendTask() posted!!%s\n", "\x1B[32m", "\x1B[0m");
          SRTreeC__sendRoutingTask__postTask();
        }
      else 
        {
          sim_log_debug(63U, "Routing", "RoutingMsgTimer.fired(): %sRouting Queue != 1 %s\n", "\x1B[31m", "\x1B[0m");
        }
    }
  else 
#line 274
    {
      sim_log_debug(64U, "Routing", "RoutingMsgTimer.fired(): %sRoutingMsg failed to be enqueued in SendingQueue!!!%s\n", "\x1B[31m", "\x1B[0m");
    }
...
#line 283
{
  ...
  sim_log_debug(65U, "Timing", "EpochTimer.fired(): %s######################################################## EPOCH %d %s\n", "\x1B[36m", SRTreeC__epochCounter[sim_node()], "\x1B[0m");
  ...
  sim_log_debug(66U, "Measure", "EpochTimer.fired(): %sMeasured %d %s\n", "\x1B[35m", measurement, "\x1B[0m");
...
#line 318
{
  sim_log_debug(67U, "Timing", "SlotTimer.fired(): %sTime to Send Data %s\n", "\x1B[33m", "\x1B[0m");
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fab5cef42f8){
#line 83
  switch (arg_0x7fab5cef42f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fab5cef42f8);
#line 83
      break;
#line 83
    }
...
#line 336
{
  sim_log_debug(69U, "SRTreeC", "NotifyAMSend.sendDone(): A Notify package sent... %s %s\n", err == SUCCESS ? "\x1B[32mTrue" : "\x1B[31mFalse", "\x1B[0m");
  SRTreeC__setNotifySendBusy(FALSE);
...
#line 326
{
  sim_log_debug(68U, "Routing", "RoutingAMSend.sendDone(): A Routing package sent... %s %s\n", err == SUCCESS ? "\x1B[32mTrue" : "\x1B[31mFalse", "\x1B[0m");
  SRTreeC__setRoutingSendBusy(FALSE);
