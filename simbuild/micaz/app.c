...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f09e61cccf8, const void *arg_0x7f09e61cb020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f09e614b618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f09e5f02020), 
int (*key_eq_fn)(void *arg_0x7f09e5f02798, void *arg_0x7f09e5f02a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f09e5cfe610, int arg_0x7f09e5cfe878);
static double RandomUniform(void );
...
#line 12
message_t /*SRTreeAppC.DataQueueC*/PacketQueueC__4__Q[1000][3];
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f09e58d2a90, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f09e58d2a90) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f09e58d2a90, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f09e58d1670, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f09e58d1670, msg, payload, len);
#line 78
...
#line 451
{
  ...
  if (sendDone == SUCCESS) {
      sim_log_debug(82U, "Routing", "sendNotifyTask(): %sSend Success!!!%s\n", "\x1B[32m", "\x1B[0m");
    }
  else 
#line 489
    {
      sim_log_debug(83U, "Routing", "sendNotifyTask(): %sSend Failed!!!%s\n", "\x1B[31m", "\x1B[0m");
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f09e58da970, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f09e58da970, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f09e5374990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f09e5374990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f09e5374990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f09e5bd8108){
#line 75
  switch (arg_0x7f09e5bd8108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f09e5bd8108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f09e5373c70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f09e5373c70, addr, msg, len);
#line 80
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f09e541c2f8){
#line 83
  switch (arg_0x7f09e541c2f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f09e541c2f8);
#line 83
      break;
#line 83
    }
...
#line 133
    {
      ...
      if (/*SRTreeAppC.DataQueueC*/PacketQueueC__4__tailIndex[sim_node()] != /*SRTreeAppC.DataQueueC*/PacketQueueC__4__headIndex[sim_node()]) 
        {
          /*SRTreeAppC.DataQueueC*/PacketQueueC__4__headIndex[sim_node()] = (/*SRTreeAppC.DataQueueC*/PacketQueueC__4__headIndex[sim_node()] + 1) % 3;
        }
...
#line 78
    {
      ...
      isFull = /*SRTreeAppC.DataQueueC*/PacketQueueC__4__size[sim_node()] == 3;
    }
#line 81
    __nesc_atomic_end(__nesc_atomic); }
...
#line 93
    {
      if (!wasEmpty) 
        {
          /*SRTreeAppC.DataQueueC*/PacketQueueC__4__tailIndex[sim_node()] = (/*SRTreeAppC.DataQueueC*/PacketQueueC__4__tailIndex[sim_node()] + 1) % 3;
        }
