...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f5a7d233cf8, const void *arg_0x7f5a7d232020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f5a7d1b2618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f5a7cf69020), 
int (*key_eq_fn)(void *arg_0x7f5a7cf69798, void *arg_0x7f5a7cf69a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f5a7cd65610, int arg_0x7f5a7cd65878);
static double RandomUniform(void );
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f5a7c90fc98, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f5a7c90fc98) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f5a7c90fc98, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f5a7c90e810, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f5a7c90e810, msg, payload, len);
#line 78
...
#line 622
{
  ...
  if (len == sizeof(NotifyParentMsg )) {
    ...
    {
      sim_log_debug(97U, "NotifyParentMsg", "receiveNotifyTask():Empty message!!! \n");
...
#line 733
{
  ...
  __nesc_hton_uint32(m->SUM.nxdata, SRTreeC__SUM[sim_node()]);
  __nesc_hton_uint32(m->COUNT.nxdata, SRTreeC__COUNT[sim_node()]);
  __nesc_hton_uint32(m->MAX.nxdata, SRTreeC__MAX[sim_node()]);
  ...
  if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) {
      sim_log_debug(99U, "NotifyParentMsg", "enqueueData(): NotifyParentMsg enqueued in SendingQueue successfully!!!\n");
...
#line 700
{
  ...
  for (i = 0; i < SRTreeC__DataQueue__size(); i++) {
      ...
      SRTreeC__SUM[sim_node()] += __nesc_ntoh_uint32(mr->SUM.nxdata);
      SRTreeC__COUNT[sim_node()] += __nesc_ntoh_uint32(mr->COUNT.nxdata);
      SRTreeC__MAX[sim_node()] = __nesc_ntoh_uint32(mr->MAX.nxdata) > SRTreeC__MAX[sim_node()] ? __nesc_ntoh_uint32(mr->MAX.nxdata) : SRTreeC__MAX[sim_node()];
...
#line 760
{
  uint32_t AVG = SRTreeC__SUM[sim_node()] / SRTreeC__COUNT[sim_node()];

  sim_log_debug(100U, "Root", "\n");
  sim_log_debug(101U, "Root", "rootResults(): %s################################################### ROOT RESULTS FOR EPOCH %d ###################################################s\n", "\x1B[34m", SRTreeC__epochCounter[sim_node()], "\x1B[0m");
  sim_log_debug(102U, "Root", "rootResults(): %s############  SUM   : %s%d %s\n", "\x1B[34m", "\x1B[35m", SRTreeC__SUM[sim_node()], "\x1B[0m");
  sim_log_debug(103U, "Root", "rootResults(): %s############  COUNT : %s%d %s\n", "\x1B[34m", "\x1B[35m", SRTreeC__COUNT[sim_node()], "\x1B[0m");
  sim_log_debug(104U, "Root", "rootResults(): %s############  AVG   : %s%d %s\n", "\x1B[34m", "\x1B[35m", AVG, "\x1B[0m");
  sim_log_debug(105U, "Root", "rootResults(): %s############  MAX   : %s%d %s\n\n", "\x1B[34m", "\x1B[35m", SRTreeC__MAX[sim_node()], "\x1B[0m");
}
...
#line 772
{
  ...
  if (SRTreeC__query1[sim_node()] > 6 || SRTreeC__query2[sim_node()] > 6) {
      sim_log_debug(106U, "Query", "calculateSubQ(): %sUnknown Query %s\n", "\x1B[31m", "\x1B[0m");
      return;
    }
...
#line 786
  ...
  sim_log_debug(107U, "Query", "calculateSubQ(): Calculcated subquerys= %d, numOfSubQ=%d\n", SRTreeC__subquerys[sim_node()], SRTreeC__numOfSubQ[sim_node()]);
}
...
# 110 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f5a7c917b48, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f5a7c917b48, msg, error);
#line 110
}
#line 110
...
# 100 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f5a7c3af990, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f5a7c3af990) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f5a7c3af990, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f5a7cc3f108){
#line 75
  switch (arg_0x7f5a7cc3f108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f5a7cc3f108);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/home/tinyos/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f5a7c3aec70, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f5a7c3aec70, addr, msg, len);
#line 80
...
#line 363
{
  ...
  SRTreeC__SUM[sim_node()] = measurement;
  SRTreeC__COUNT[sim_node()] = 1;
  SRTreeC__MAX[sim_node()] = measurement;
}
...
# 83 "/home/tinyos/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f5a7c4572f8){
#line 83
  switch (arg_0x7f5a7c4572f8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f5a7c4572f8);
#line 83
      break;
#line 83
    }
